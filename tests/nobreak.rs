...
mod ascii {
    ...
    fn _1() -> Result<()> {
        ...
        let len = Wrapper::new(before, 3, &mut after)?.wrap()?;
    ...
    fn _7() -> Result<()> {
        ...
        let len = Wrapper::new(before, 80, &mut after)?.wrap()?;
...
mod ascii_existnl {
    ...
    #[test]
    fn _33() -> Result<()> {
        // note, this example shows that we dont trim consecutive NL(s)
        let before = "hh \n  \n  hhh";
        let mut after = [0u8; 256];
        let len = Wrapper::new(before, 3, &mut after)?.wrap()?;
...
mod nonascii {
    ...
    fn _1() -> Result<()> {
        ...
        let len = Wrapper::new(before, 7, &mut after)?.wrap()?;
    ...
    fn _8() -> Result<()> {
        ...
        let len = Wrapper::new(before, 2, &mut after)?.wrap()?;
...
mod nonascii_existnl {
    ...
    fn _8() -> Result<()> {
        ...
        let len = Wrapper::new(before, 4, &mut after)?.wrap()?;
