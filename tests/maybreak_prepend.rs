...
mod ascii {
    ...
    fn _1() -> Result<()> {
        ...
        let len =
            Wrapper::new(before, 3, &mut after)?.wrap_use_style(WrapStyle::MayBreakPrepend("-"))?;
    ...
    fn _3() -> Result<()> {
        ...
        let mut after = [0u8; 256];
        let len =
            Wrapper::new(before, 4, &mut after)?.wrap_use_style(WrapStyle::MayBreakPrepend("⤶"))?;
...
mod nonascii {
    ...
    fn _1() -> Result<()> {
        ...
        let mut after = [0u8; 256];
        let len =
            Wrapper::new(before, 7, &mut after)?.wrap_use_style(WrapStyle::MayBreakPrepend("⤶"))?;
...
mod nonascii_existnl {
    ...
    fn _7() -> Result<()> {
        ...
        let mut after = [0u8; 256];
        let len =
            Wrapper::new(before, 1, &mut after)?.wrap_use_style(WrapStyle::MayBreakPrepend("⤶"))?;
        assert_eq!(
            &after[..len],
            "\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n\nＨ\n".as_bytes()
        );
